...
/**
 * 
 * @author JC, Elsie, Adam, Shi Yu, Ke
 * 
 *
 */
public class Lab6 {
	...
	//private static final EV3LargeRegulatedMotor leftSMotor = new EV3LargeRegulatedMotor(LocalEV3.get().getPort("B"));
	//private static final EV3LargeRegulatedMotor rightSMotor = new EV3LargeRegulatedMotor(LocalEV3.get().getPort("C"));
	...
	public static void main(String[] args) {
		...
		SampleProvider colorSensor = cS.getRGBMode();
