...
//  Need to convert US result to an integer [0,255]
	/**
	 * Runs the ultrasonic sensor poller
	 */
	public void run() {
...
/**
 * Gets the distance between the sensor and the closest detected object
 * @return the distance between the sensor and the closest detected object
 */
	public int getDistance(){
		return distance;
	}
	/**
	 * Determines if the sensor detects an object in front of it or not
	 * @return true if there is an object in front of the sensor, false otherwise
	 */
