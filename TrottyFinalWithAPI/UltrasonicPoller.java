...
public class UltrasonicPoller extends Thread{
	 ...
	 * @param us where the samples come from
	 * @param usData the data recorded from the ultrasonic sensor
	 */
...
//  Need to convert US result to an integer [0,255]
	...
	/**
	 * start and continue collecting data from the associated sensor
	 */
	public void run() {
	...
	/**
	 * determines if something is in the sight radius of the sensor
	 * @return a boolean representing if the sensor sees anything
	 */
