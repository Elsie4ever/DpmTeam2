...
public class StartTrotty1 {
	...
	public static void main(String[] args) {
		...
		final int yCenter = wifi.yCenter;
		final int xCenter = wifi.xCenter;
			...
			(new Thread() {
				public void run() {
					...
					ObjectFinder of = new ObjectFinder(leftMotor, rightMotor, navigator, lsl, odo,
							usPollerF, usPollerS, usl, lsPoller, resolution, wifi.getxHalf(), wifi.getyHalf(), clawMotor, xCenter, yCenter);
					of.pointDriver();
				} 
			}).start();
